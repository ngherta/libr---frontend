...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcApp_componentsAlertComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AlertComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AlertComponent_div_1_Template_a_click_1_listener() {
    ...
    AlertComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 1,
      consts: [[1, "alert-container"], ["style", "z-index: 99999; ", 3, "class", 4, "ngFor", "ngForOf"], [2, "z-index", "99999"], [1, "close", 3, "click"], [3, "innerHTML"]],
  ...
  function srcApp_servicesAccountServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AccountService = /*#__PURE__*/function () {
      function AccountService(router, http) {
        ...
        this.router = router;
        this.http = http; // this.userId = JSON.parse(localStorage.getItem('user')).id;
      ...
      _createClass(AccountService, [{
        ...
        key: "editUserFromProfile",
        value: function editUserFromProfile(id, params) {
          var _this6 = this;
          ...
          return this.http.put("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/users/").concat(id), params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (x) {
            ...
            if (id === _this6.userValue.id) {
              // update local storage
              var user = Object.assign(Object.assign({}, _this6.userValue), params);
              localStorage.setItem('user', JSON.stringify(user)); // publish updated user to subscribers
        ...
        key: "updatePass",
        value: function updatePass(id, newPassword) {
          var _this7 = this;

          return this.http.put("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/users/password/").concat(id), {
            'newPassword': newPassword
          }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (x) {
            // update stored user if the logged in user updated their own record
            if (id === _this7.userValue.id) {
              // update local storage
              var user = Object.assign(Object.assign({}, _this7.userValue), newPassword);
              localStorage.setItem('user', JSON.stringify(user)); // publish updated user to subscribers
        ...
        value: function sendEmail(id, type) {
          return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/emails"), {
            'userId': id,
            'emailType': type
          }).subscribe();
        }
        ...
        key: "getActuatorInfo",
        value: function getActuatorInfo() {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/actuator/info"));
        }
      }, {
        key: "userValue",
        get: function get() {
  ...
  /***/
  function srcApp_servicesBookServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var BookService = /*#__PURE__*/function () {
      function BookService(router, http) {
      ...
      _createClass(BookService, [{
        key: "findInGoogleApi",
        value: function findInGoogleApi(keyword) {
          return this.http.get("https://www.googleapis.com/books/v1/volumes?q=" + keyword);
        }
      }, {
        key: "save",
        value: function save(book) {
          return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/books"), book);
        }
      }, {
        key: "getAllDashboard",
        value: function getAllDashboard() {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/dashboard"));
        }
      }, {
        key: "getById",
        value: function getById(id) {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/books/").concat(id));
        }
      }, {
        key: "getAll",
        value: function getAll() {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/books"));
        }
      }, {
        key: "getAllFiltered",
        value: function getAllFiltered() {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/books/filtered"));
        }
      }, {
        key: "getAllCategories",
        value: function getAllCategories() {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/books/categories"));
        }
      }, {
        key: "delete",
        value: function _delete(id) {
          return this.http["delete"]("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/books/").concat(id)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (x) {
            return x;
          }));
        }
      }, {
        key: "register",
        value: function register(book, userId, isManuallyAdded) {
          book.userId = userId;
        ...
        key: "vote",
        value: function vote(userId, bookId, _vote) {
          return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/vote"), {
            "userId": userId,
            "bookId": bookId,
            "vote": _vote
          });
        ...
        key: "getStatusInfo",
        value: function getStatusInfo(status, bookId) {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/book-actions/").concat(status, "/book/").concat(bookId));
        }
      }, {
        key: "addBookReaction",
        value: function addBookReaction(userId, bookId, reaction) {
          return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/book-reaction"), {
            "userId": userId,
            "bookId": bookId,
            "type": reaction
          });
        ...
        key: "addCommentReaction",
        value: function addCommentReaction(userId, commentId, reaction) {
          return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/comment-reaction"), {
            "userId": userId,
            "commentId": commentId,
            "type": reaction
          });
        ...
        key: "comment",
        value: function comment(_comment, userId, bookId) {
          return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/comments/"), {
            "userId": userId,
            "bookId": bookId,
            "comment": _comment
          });
        ...
        key: "updateStatus",
        value: function updateStatus(userId, bookId, status) {
          return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/book-actions/update-status"), {
            "bookId": bookId,
            "userId": userId,
            "newStatus": status
          });
        ...
        key: "getBookActionByStatus",
        value: function getBookActionByStatus(status) {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/book-actions/").concat(status));
        }
      }, {
        key: "update",
        value: function update(id, params) {
          return this.http.put("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/books/").concat(id), params);
        }
      }, {
        key: "getActuatorInfo",
        value: function getActuatorInfo() {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/actuator/info"));
        }
      }, {
        key: "getActuatorHealth",
        value: function getActuatorHealth() {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/actuator/health"));
        }
      }, {
        key: "getActuatorMetrics",
        value: function getActuatorMetrics(url) {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "/actuator/metrics/").concat(url));
        }
      }, {
        key: "bookValue",
        get: function get() {
    ...
    BookService.ɵfac = function BookService_Factory(t) {
      return new (t || BookService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"]));
    };
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_profile_profile_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! @app/profile/profile.component */
    "./src/app/profile/profile.component.ts");
    /* harmony import */


    var _app_inside_book_inside_book_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @app/inside-book/inside-book.component */
    "./src/app/inside-book/inside-book.component.ts");
    /* harmony import */


    var _app_users_change_password_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! @app/users/change-password.component */
    "./src/app/users/change-password.component.ts");
    /* harmony import */


    var _app_profile_edit_profile_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! @app/profile/edit-profile.component */
    "./src/app/profile/edit-profile.component.ts");
    /* harmony import */


    var _app_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var booksModule = function booksModule() {
      ...
      /*! ./books/books.module */
      "./src/app/books/books.module.ts")).then(function (x) {
        return x.BooksModule;
      });
    };
    ...
    var routes = [{
      ...
      path: 'profile/:id',
      component: _app_profile_profile_component__WEBPACK_IMPORTED_MODULE_4__["ProfileComponent"]
    }, {
      path: 'profile/edit/:id',
      component: _app_profile_edit_profile_component__WEBPACK_IMPORTED_MODULE_7__["EditProfileComponent"]
    }, {
      path: 'books',
      children: [{
        path: '',
        ...
        path: ':id',
        component: _app_inside_book_inside_book_component__WEBPACK_IMPORTED_MODULE_5__["InsideBookComponent"]
      }]
    }, {
      path: 'auth/password/:id',
      component: _app_users_change_password_component__WEBPACK_IMPORTED_MODULE_6__["ChangePasswordComponent"]
    }, {
      path: 'dashboard',
      component: _app_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_8__["DashboardComponent"]
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_nav_0_a_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_nav_0_a_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_nav_0_a_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_nav_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_nav_0_Template_a_click_11_listener() {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(accountService) {
        ...
        this.accountService = accountService; // this.statusOfUser = accountService

        this.accountService.user.subscribe(function (x) {
          return _this9.user = x;
        }); // if (this.user !== null) {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _inside_book_inside_book_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./inside-book/inside-book.component */
    "./src/app/inside-book/inside-book.component.ts");
    /* harmony import */


    var _app_users_change_password_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! @app/users/change-password.component */
    "./src/app/users/change-password.component.ts");
    /* harmony import */


    var _app_profile_edit_profile_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! @app/profile/edit-profile.component */
    "./src/app/profile/edit-profile.component.ts");
    /* harmony import */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_10__["NgbModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_4__["MatCardModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_12__["NoopAnimationsModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatFormFieldModule"], angular_datatables__WEBPACK_IMPORTED_MODULE_13__["DataTablesModule"], ng_apexcharts__WEBPACK_IMPORTED_MODULE_17__["NgApexchartsModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _components__WEBPACK_IMPORTED_MODULE_8__["AlertComponent"], _home__WEBPACK_IMPORTED_MODULE_9__["HomeComponent"], _app_users_change_password_component__WEBPACK_IMPORTED_MODULE_15__["ChangePasswordComponent"], _inside_book_inside_book_component__WEBPACK_IMPORTED_MODULE_14__["InsideBookComponent"], _profile_profile_component__WEBPACK_IMPORTED_MODULE_11__["ProfileComponent"], _app_profile_edit_profile_component__WEBPACK_IMPORTED_MODULE_16__["EditProfileComponent"], _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_18__["DashboardComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_10__["NgbModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_4__["MatCardModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_12__["NoopAnimationsModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatFormFieldModule"], angular_datatables__WEBPACK_IMPORTED_MODULE_13__["DataTablesModule"], ng_apexcharts__WEBPACK_IMPORTED_MODULE_17__["NgApexchartsModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DashboardComponent = /*#__PURE__*/function () {
      function DashboardComponent(activatedRoute, userService, bookService, alertService) {
      ...
      _createClass(DashboardComponent, [{
        ...
        key: "getActuatorMetrics",
        value: function getActuatorMetrics() {
          var _this10 = this;

          this.bookService.getActuatorMetrics('jvm.buffer.memory.used').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (data) {
            _this10.MemoryUsed = data["measurements"][0].value;
          });
          this.bookService.getActuatorMetrics('system.cpu.count').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (data) {
            _this10.NumberOfProcessors = data["measurements"][0].value;
          });
          this.bookService.getActuatorMetrics('http.server.requests').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (data) {
            _this10.HttpRequest = data["measurements"][0].value;
            _this10.HttpRequestMax = data["measurements"][1].value;
            _this10.HttpRequestTotal = data["measurements"][2].value;
          });
          this.bookService.getActuatorMetrics('jvm.memory.used').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (data) {
            _this10.UsedMemory = data["measurements"][0].value;
          });
          this.bookService.getActuatorMetrics('process.uptime').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (data) {
            _this10.UpTime = data["measurements"][0].value;
        ...
        value: function getActuatorHealth() {
          ...
          this.bookService.getActuatorHealth().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (data) {
            _this11.actuatorHealth = data;
          });
        }
      }, {
        key: "getActuatorInfo",
        value: function getActuatorInfo() {
          ...
          this.bookService.getActuatorInfo().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (data) {
            _this12.actuatorInfo = data;
          });
        }
      }, {
        key: "fetchAllDashboard",
        value: function fetchAllDashboard() {
          var _this13 = this;

          this.bookService.getAllDashboard().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (data) {
            _this13.dashboard = data;

            for (var i = 0; i < _this13.dashboard.booksPerCategory.length; i++) {
              _this13.categoriesName.push(_this13.dashboard.booksPerCategory[i].category);

              _this13.categoriesCount.push(_this13.dashboard.booksPerCategory[i].count);
            }

            _this13.countOfSubmittedBooks = _this13.dashboard.allSubmittedAndInLibraryBooks.SUBMITTED;
            _this13.countOfInlibraryBooks = _this13.dashboard.allSubmittedAndInLibraryBooks.IN_LIBRARY;
            Object.entries(_this13.dashboard.submittedPerWeek);

            for (var _i = 0; _i < 4; _i++) {
              _this13.submittedPerWeekName.push(Object.entries(_this13.dashboard.submittedPerWeek)[_i][0].toString());

              _this13.submittedPerWeekCount.push(Number.parseInt(Object.entries(_this13.dashboard.submittedPerWeek)[_i][1].toString()));
            }
          });
        }
      }]);
    ...
    DashboardComponent.ɵfac = function DashboardComponent_Factory(t) {
      return new (t || DashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services__WEBPACK_IMPORTED_MODULE_3__["AccountService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_book_service__WEBPACK_IMPORTED_MODULE_4__["BookService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services__WEBPACK_IMPORTED_MODULE_3__["AlertService"]));
    };
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_services_book_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! @app/_services/book.service */
    "./src/app/_services/book.service.ts");
    /* harmony import */
    ...
    function HomeComponent_div_10_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_10_div_1_Template_button_click_50_listener() {
          ...
          return ctx_r6.saveBook(book_r5);
        });
    ...
    function HomeComponent_span_29_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_span_29_Template_a_click_1_listener() {
          ...
          return ctx_r9.filterCategoryValue(category_r8.category.toString());
        });
    ...
    function HomeComponent_div_63_div_2_span_44_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var book_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).$implicit;
    ...
    function HomeComponent_div_63_div_2_button_45_Template(rf, ctx) {
      if (rf & 1) {
        var _r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 84);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_63_div_2_button_45_Template_button_click_0_listener() {
          ...
          return ctx_r17.status(book_r11.id, "REQUESTED");
        });
    ...
    function HomeComponent_div_63_div_2_div_46_button_5_Template(rf, ctx) {
      if (rf & 1) {
        var _r28 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 18);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_63_div_2_div_46_button_5_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r28);

          var book_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3).$implicit;

          var ctx_r26 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r26.status(book_r11.id, "REJECTED");
        });
    ...
    function HomeComponent_div_63_div_2_div_46_button_6_Template(rf, ctx) {
      if (rf & 1) {
        var _r31 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 18);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_63_div_2_div_46_button_6_Template_button_click_0_listener() {
          ...
          return ctx_r29.status(book_r11.id, "APPROVED");
        });
    ...
    function HomeComponent_div_63_div_2_div_46_button_7_Template(rf, ctx) {
      if (rf & 1) {
        var _r34 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 18);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_63_div_2_div_46_button_7_Template_button_click_0_listener() {
          ...
          return ctx_r32.status(book_r11.id, "ORDERED");
        });
    ...
    function HomeComponent_div_63_div_2_div_46_button_8_Template(rf, ctx) {
      if (rf & 1) {
        var _r37 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 18);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_63_div_2_div_46_button_8_Template_button_click_0_listener() {
          ...
          return ctx_r35.status(book_r11.id, "IN_LIBRARY");
        });
    ...
    function HomeComponent_div_63_div_2_div_46_button_9_Template(rf, ctx) {
      if (rf & 1) {
        var _r40 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 18);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_63_div_2_div_46_button_9_Template_button_click_0_listener() {
          ...
          return ctx_r38.status(book_r11.id, "REQUESTED");
        });
    ...
    function HomeComponent_div_63_div_2_div_46_button_10_Template(rf, ctx) {
      if (rf & 1) {
        var _r43 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 18);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_63_div_2_div_46_button_10_Template_button_click_0_listener() {
          ...
          return ctx_r41.status(book_r11.id, "IN_USE");
        });
    ...
    function HomeComponent_div_63_div_2_div_46_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HomeComponent_div_63_div_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_63_div_2_Template_button_click_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r47);

          var book_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;

          var ctx_r45 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r45.upVote(book_r11.id);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_63_div_2_Template_button_click_8_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r47);
          ...
          return ctx_r48.downVote(book_r11.id);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_63_div_2_Template_button_click_55_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r47);
          ...
          return ctx_r50.addBookReaction(book_r11.id, "HEART");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_63_div_2_Template_button_click_58_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r47);
          ...
          return ctx_r52.addBookReaction(book_r11.id, "LAUGH");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_63_div_2_Template_button_click_61_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r47);
          ...
          return ctx_r54.addBookReaction(book_r11.id, "SAD");
        });
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(bookService, accountService, alertService, route, router) {
        ...
        this.condition = false; // this.userId = localStorage.getItem('user').id;
      ...
      _createClass(HomeComponent, [{
        ...
        value: function fetchAllCategories() {
          ...
          this.bookService.getAllCategories().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (categoriesData) {
            _this14.categories = categoriesData;
            _this14.countOfAllCategories = 0;

            var _iterator = _createForOfIteratorHelper(_this14.categories),
                _step;

            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                var category = _step.value;
                _this14.countOfAllCategories += category.count;
              }
            } catch (err) {
              _iterator.e(err);
            } finally {
        ...
        value: function showData(data) {
          ...
          this.bookService.findInGoogleApi(data).subscribe(function (dataResponse) {
            for (var i = 0; i < dataResponse["items"].length; i++) {
              if (i === 5) {
                break;
              }
              ...
              _this15.books.push(b);
            }

            _this15.condition = true;
          });
        }
      }, {
        key: "saveBook",
        value: function saveBook(book) {
          ...
          this.bookService.save(book).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (data) {
            _this16.fetchBooks();

            _this16.alertService.success('Book added successfully', {
              keepAfterRouteChange: false
            });
          }, function (error) {
            _this16.alertService.error(error.error.errorMessage);
        ...
        key: "status",
        value: function status(bookId, bookStatus) {
          var _this17 = this;

          this.bookService.updateStatus(this.userId, bookId, bookStatus).subscribe(function (data) {
            _this17.fetchBooks();

            if (bookStatus === 'REQUESTED') {
              _this17.alertService.success('Book requested successfully', {
                keepAfterRouteChange: false
              });
            }
          }, function (error) {
            _this17.alertService.error(error.error.errorMessage);

            _this17.loading = false;
          });
        }
      }, {
        key: "filterCategoryValue",
        value: function filterCategoryValue(category) {
          this.orderCategory = category;
        }
      }, {
        key: "filterStatusValue",
        value: function filterStatusValue(status) {
          this.orderStatus = status;
        }
      }, {
        key: "upVote",
        value: function upVote(bookId) {
          var _this18 = this;

          this.bookService.vote(this.userId, bookId, 1).subscribe(function (data) {
            _this18.fetchBooks();
          }, function (error) {
            _this18.alertService.error(error.error.errorMessage);
        ...
        value: function fetchBooks() {
          ...
          this.bookService.getAllFiltered().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (booksD) {
            _this19.booksData = booksD;
            _this19.booksCount = 0;

            var _iterator2 = _createForOfIteratorHelper(booksD),
                _step2;
        ...
        key: "downVote",
        value: function downVote(bookId) {
          var _this20 = this;

          this.bookService.vote(this.userId, bookId, -1).subscribe(function (data) {
            _this20.fetchBooks();
          }, function (error) {
            _this20.alertService.error(error.error.errorMessage);
        ...
        key: "addBookReaction",
        value: function addBookReaction(bookId, reaction) {
          var _this21 = this;

          this.bookService.addBookReaction(this.userId, bookId, reaction).subscribe(function (data) {
            _this21.fetchBooks();
          }, function (error) {
            _this21.alertService.error(error.error.errorMessage);
        ...
        key: "orderByCategory",
        value: function orderByCategory(categories) {
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function HomeComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function HomeComponent_Template_div_keyup_4_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r57);

            var _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](6);

            return ctx.showData(_r0.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_span_click_14_listener() {
            return ctx.filterStatusValue("IN_LIBRARY");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_a_click_25_listener() {
            return ctx.filterCategoryValue("All");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_label_click_32_listener() {
            return ctx.filterStatusValue("");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_label_click_36_listener() {
            return ctx.filterStatusValue("SUBMITTED");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_label_click_40_listener() {
            return ctx.filterStatusValue("APPROVED");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_label_click_44_listener() {
            return ctx.filterStatusValue("ORDERED");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_label_click_48_listener() {
            return ctx.filterStatusValue("IN_LIBRARY");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_label_click_52_listener() {
            return ctx.filterStatusValue("REQUESTED");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_label_click_56_listener() {
            return ctx.filterStatusValue("IN_USE");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_label_click_60_listener() {
            return ctx.filterStatusValue("RETURNED");
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
        ...
        return [{
          type: _app_services_book_service__WEBPACK_IMPORTED_MODULE_2__["BookService"]
        }, {
          type: _app_services__WEBPACK_IMPORTED_MODULE_3__["AccountService"]
        }, {
          type: _app_services__WEBPACK_IMPORTED_MODULE_3__["AlertService"]
  ...
  /***/
  function srcAppInsideBookInsideBookComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "InsideBookComponent", function () {
      return InsideBookComponent;
    });
    /* harmony import */
    ...
    function InsideBookComponent_div_0_div_98_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function InsideBookComponent_div_0_div_109_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function InsideBookComponent_div_0_div_109_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function InsideBookComponent_div_0_span_112_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "span", 47);
      }
    }

    function InsideBookComponent_div_0_li_115_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InsideBookComponent_div_0_li_115_Template_button_click_10_listener() {
          ...
          return ctx_r7.addCommentReaction(comment_r6.id, "HEART");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InsideBookComponent_div_0_li_115_Template_button_click_13_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);
          ...
          return ctx_r9.addCommentReaction(comment_r6.id, "LAUGH");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InsideBookComponent_div_0_li_115_Template_button_click_16_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);
          ...
          return ctx_r10.addCommentReaction(comment_r6.id, "SAD");
        });
    ...
    function InsideBookComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InsideBookComponent_div_0_Template_div_click_57_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          ctx_r11.bookActionResponse = null;
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InsideBookComponent_div_0_Template_div_click_63_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          ctx_r13.bookActionResponse = null;
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InsideBookComponent_div_0_Template_div_click_71_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          ctx_r14.bookActionResponse = null;
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InsideBookComponent_div_0_Template_div_click_77_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          ctx_r15.bookActionResponse = null;
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InsideBookComponent_div_0_Template_div_click_83_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          ctx_r16.bookActionResponse = null;
          return ctx_r16.getStatusInfo(ctx_r16.book.id, "IN_USE");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function InsideBookComponent_div_0_Template_form_ngSubmit_104_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          ctx_r17.onSubmit();
          return ctx_r17.formComments.reset();
        });
    ...
    var InsideBookComponent = /*#__PURE__*/function () {
      function InsideBookComponent(bookService, activatedRoute, formBuilder, route, router, accountService, alertService) {
        _classCallCheck(this, InsideBookComponent);
      ...
      _createClass(InsideBookComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
        ...
        key: "fetchBook",
        value: function fetchBook() {
          var _this22 = this;

          this.bookService.getById(this.bookId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (book) {
            return _this22.book = book;
        ...
        value: function onSubmit() {
          ...
          this.loading = true;
          this.bookService.comment(this.f.comment.value, this.userId, this.book.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function (data) {
            _this23.bookService.getById(_this23.bookId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (book) {
              return _this23.book = book;
            }, _this23.loading = false)).subscribe();

            _this23.submitted = false;
          }, function (error) {
            _this23.alertService.error(error.error.errorMessage);
        ...
        key: "getStatusInfo",
        value: function getStatusInfo(bookId, status) {
          var _this24 = this;

          this.bookService.getStatusInfo(status, bookId).subscribe(function (data) {
            _this24.bookActionResponse = data;
          });
        }
      }, {
        key: "addCommentReaction",
        value: function addCommentReaction(commentId, reaction) {
          var _this25 = this;

          this.bookService.addCommentReaction(this.userId, commentId, reaction).subscribe(function (data) {
            _this25.fetchBook();
          }, function (error) {
            _this25.alertService.error(error.error.errorMessage);
    ...
    InsideBookComponent.ɵfac = function InsideBookComponent_Factory(t) {
      return new (t || InsideBookComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services_book_service__WEBPACK_IMPORTED_MODULE_4__["BookService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services__WEBPACK_IMPORTED_MODULE_6__["AccountService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_services__WEBPACK_IMPORTED_MODULE_6__["AlertService"]));
    };

    InsideBookComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: InsideBookComponent,
      selectors: [["app-inside-book"]],
      decls: 1,
      vars: 1,
      consts: [["class", "main-div", 4, "ngIf"], [1, "main-div"], [1, "card"], [1, "d-flex"], [1, "title"], [1, "badge", "rounded-pill", "bg-warning", "text-dark", "vote-badge"], [1, "badge", "bg-secondary"], [1, "first-card-info"], [1, "img-container"], ["alt", "Image of book", 1, "img-of-book", 3, "src"], [1, "first-info-container"], [1, "info-about-book"], [1, "info-book"], [2, "width", "20%"], [2, "max-height", "208px", "overflow", "auto"], [1, "status-bar"], [1, "md-stepper-horizontal", "orange"], ["data-toggle", "modal", "data-target", "#exampleModalCenter", 1, "md-step", 3, "ngClass", "click"], [1, "md-step-circle"], [1, "md-step-title"], [1, "md-step-bar-left"], [1, "md-step-bar-right"], [1, "md-step-optional"], ["id", "exampleModalCenter", "tabindex", "-1", "role", "dialog", "aria-labelledby", "exampleModalCenterTitle", "aria-hidden", "true", 1, "modal", "fade"], ["role", "document", 1, "modal-dialog", "modal-dialog-centered"], [1, "modal-content"], [1, "modal-header"], ["id", "exampleModalLongTitle", 1, "modal-title"], ["type", "button", "data-dismiss", "modal", "aria-label", "Close", 1, "close"], ["aria-hidden", "true"], ["class", "modal-body", 4, "ngIf"], [1, "modal-footer"], ["type", "button", "data-dismiss", "modal", 1, "btn", "btn-secondary"], [1, "card", "comments-container"], [1, "form-group", "textarea-container", 2, "width", "50%"], [3, "formGroup", "ngSubmit"], [1, "form-group"], ["for", "comment"], ["type", "text", "formControlName", "comment", "name", "comment", 1, "form-control", 3, "ngClass"], ["class", "invalid-feedback", 4, "ngIf"], [1, "btn", "btn-primary", 3, "disabled"], ["class", "spinner-border spinner-border-sm mr-1", 4, "ngIf"], [1, "comments-list"], ["class", "comments-item", 4, "ngFor", "ngForOf"], [1, "modal-body"], [1, "invalid-feedback"], [4, "ngIf"], [1, "spinner-border", "spinner-border-sm", "mr-1"], [1, "comments-item"], [2, "display", "flex"], [1, "comment-name"], [2, "margin-left", "auto"], [1, "container", "comment-text", 2, "padding", "10px"], [1, "reaction-container"], [1, "reaction-field"], [1, "badge", "rounded-pill", "bg-light", "text-dark", 3, "click"]],
      template: function InsideBookComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](InsideBookComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          ...
          type: _app_services__WEBPACK_IMPORTED_MODULE_6__["AccountService"]
        }, {
          type: _app_services__WEBPACK_IMPORTED_MODULE_6__["AlertService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppProfileEditProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function EditProfileComponent_h1_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function EditProfileComponent_div_8_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function EditProfileComponent_div_13_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function EditProfileComponent_div_19_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function EditProfileComponent_div_24_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function EditProfileComponent_div_24_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 20);
    ...
    function EditProfileComponent_div_30_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function EditProfileComponent_span_33_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var EditProfileComponent = /*#__PURE__*/function () {
      function EditProfileComponent(formBuilder, route, router, accountService, alertService) {
      ...
      _createClass(EditProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (!this.isAddMode) {
            this.accountService.getById(this.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function (x) {
              _this26.f.firstName.setValue(x.firstName);

              _this26.f.lastName.setValue(x.lastName);

              _this26.f.age.setValue(x.age);

              _this26.f.phone.setValue(x.phone);

              _this26.f.email.setValue(x.email);

              _this26.f.role.setValue(x.role);
            });
          }
        ...
        value: function updateUser() {
          ...
          this.accountService.editUserFromProfile(this.id, this.form.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function (data) {
            _this27.alertService.success('Update successful', {
              keepAfterRouteChange: true
            });

            _this27.router.navigate(['../../../profile/' + _this27.id, {
              relativeTo: _this27.id
            }]);
          }, function (error) {
            _this27.alertService.error(error.error.errorMessage);
    ...
    EditProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 37,
      vars: 25,
      consts: [[2, "padding", "20px 20%"], [4, "ngIf"], [3, "formGroup", "ngSubmit"], [1, "form-row"], [1, "form-group", "col"], ["for", "firstName"], ["type", "text", "required", "", "formControlName", "firstName", 1, "form-control", 3, "ngClass"], ["class", "invalid-feedback", 4, "ngIf"], ["for", "lastName"], ["type", "text", "formControlName", "lastName", 1, "form-control", 3, "ngClass"], ["for", "age"], ["type", "text", "formControlName", "age", 1, "form-control", 3, "ngClass"], ["for", "phone"], ["type", "text", "formControlName", "phone", 1, "form-control", 3, "ngClass"], ["for", "email"], ["type", "text", "formControlName", "email", 1, "form-control", 3, "ngClass"], [1, "form-group"], [1, "btn", "btn-primary", 3, "disabled"], ["class", "spinner-border spinner-border-sm mr-1", 4, "ngIf"], [1, "btn", "btn-link", 3, "routerLink"], [1, "invalid-feedback"], [1, "spinner-border", "spinner-border-sm", "mr-1"]],
  ...
  function srcAppProfileProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_services_book_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @app/_services/book.service */
    "./src/app/_services/book.service.ts");
    /* harmony import */
    ...
    function ProfileComponent_div_37_tr_15_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileComponent_div_37_tr_15_Template_button_click_9_listener() {
          ...
          return ctx_r4.status(request_r3.user.id, request_r3.book.id, "IN_USE");
        });
    ...
    function ProfileComponent_div_38_tr_19_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ProfileComponent = /*#__PURE__*/function () {
      function ProfileComponent(activatedRoute, userService, bookService, alertService) {
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userService.getById(this.userId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (user) {
        ...
        key: "status",
        value: function status(userId, bookId, bookStatus) {
          var _this29 = this;

          this.bookService.updateStatus(userId, bookId, bookStatus).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (data) {
            _this29.fetchBookActionByStatusRequested();

            if (bookStatus === 'REQUESTED') {
              _this29.alertService.success('Book requested successfully', {
                keepAfterRouteChange: false
              });
            }
          }, function (error) {
            _this29.alertService.error(error.error.errorMessage);

            _this29.loading = false;
          });
        }
      }, {
        key: "fetchBookActionByStatusSubmitted",
        value: function fetchBookActionByStatusSubmitted() {
          var _this30 = this;

          this.bookService.getBookActionByStatus('SUBMITTED').subscribe(function (dataResponse) {
            _this30.bookAction = dataResponse;

            _this30.dtTriggerAdmin.next();
          });
        }
      }, {
        key: "fetchBookActionByStatusRequested",
        value: function fetchBookActionByStatusRequested() {
          var _this31 = this;

          this.bookService.getBookActionByStatus('REQUESTED').subscribe(function (dataResponse) {
            _this31.bookActionRequested = dataResponse;

            _this31.dtTriggerUser.next();
          });
        }
      }, {
        key: "filterItemsOfType",
        value: function filterItemsOfType(userId) {
          return this.bookAction.filter(function (x) {
    ...
    ProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 39,
      vars: 10,
      consts: [[1, "container"], [1, "profile-container"], [1, "d-flex", "mb-5"], ["width", "350px", "height", "auto", "src", "https://devtalk.blender.org/uploads/default/original/2X/c/cbd0b1a6345a44b58dda0f6a355eb39ce4e8a56a.png", "alt", "Profile image", 2, "margin", "0 auto"], [1, "profile-info"], [1, ""], [1, "profile-button"], [1, "btn", "btn-info", 3, "href"], ["routerLinkActive", "active", 1, "btn", "btn-primary", 2, "margin-right", "15px", 3, "href"], ["style", "margin-top: 20px;", "class", "dashboard-container", 4, "ngIf"], [1, "dashboard-container", 2, "margin-top", "20px"], ["datatable", "", 1, "table", 3, "dtOptions", "dtTrigger"], ["scope", "col"], ["id", "test", 4, "ngFor", "ngForOf"], ["id", "test"], ["href", "#"], ["type", "button", 1, "btn", "btn-dark", 3, "click"], [4, "ngFor", "ngForOf"], [3, "href"]],
      ...
      directives: [_angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterLinkActive"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgIf"], angular_datatables__WEBPACK_IMPORTED_MODULE_7__["DataTableDirective"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgForOf"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProfileComponent, [{
        ...
        return [{
          ...
          type: _app_services_book_service__WEBPACK_IMPORTED_MODULE_5__["BookService"]
        }, {
          type: _app_services__WEBPACK_IMPORTED_MODULE_4__["AlertService"]
        }];
      }, null);
  ...
  /***/
  function srcAppUsersChangePasswordComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ChangePasswordComponent = /*#__PURE__*/function () {
      function ChangePasswordComponent(formBuilder, route, router, accountService, alertService) {
      ...
      _createClass(ChangePasswordComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.id = this.route.snapshot.params['id']; // this.isAddMode = !this.id;
        ...
        value: function updatePassword() {
          ...
          this.accountService.updatePass(this.id, this.f.newPassword.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function (data) {
            _this32.alertService.success('Update successful', {
              keepAfterRouteChange: true
            });

            _this32.router.navigate(['../../../profile/' + _this32.id, {
              relativeTo: _this32.id
            }]);
          }, function (error) {
            _this32.alertService.error(error.error(error));

            _this32.loading = false;
          });
        }
      }, {
        key: "newMatchesConfirm",
        value: function newMatchesConfirm(newPassword, confirmPassword) {
          return function (group) {
            var passwordInput = group.controls[newPassword];
    ...
    ChangePasswordComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 20,
      vars: 11,
      consts: [[1, "card"], [1, "card-header"], [1, "card-body"], [1, "form-container-change-password"], [3, "formGroup", "ngSubmit"], [1, "form-group"], ["for", "newPassword"], ["type", "password", "formControlName", "newPassword", 1, "form-control", 3, "ngClass"], ["class", "invalid-feedback", 4, "ngIf"], ["for", "confirmPassword"], ["type", "password", "formControlName", "confirmPassword", 1, "form-control", 3, "ngClass"], [1, "btn", "btn-primary", 3, "disabled"], ["class", "spinner-border spinner-border-sm mr-1", 4, "ngIf"], [1, "invalid-feedback"], [4, "ngIf"], [1, "spinner-border", "spinner-border-sm", "mr-1"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Kirill\IdeaProjects\libr-frontend\libr---frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
